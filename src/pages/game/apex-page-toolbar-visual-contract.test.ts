...
const source = readFileSync(
  fileURLToPath(new URL('./ApexPage.vue', import.meta.url)),
  'utf8',
);
const enUs = readFileSync(
  fileURLToPath(new URL('../../i18n/locales/en-US/apex.ts', import.meta.url)),
  'utf8',
);
const zhCn = readFileSync(
  fileURLToPath(new URL('../../i18n/locales/zh-CN/apex.ts', import.meta.url)),
  'utf8',
);
