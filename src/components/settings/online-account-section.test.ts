...
const source = readFileSync(new URL('./OnlineAccountSection.vue', import.meta.url), 'utf8');
const settingsView = readFileSync(
  new URL('../../views/SettingsView.vue', import.meta.url),
  'utf8',
);
const registry = readFileSync(new URL('../../icons/mdi-icons.ts', import.meta.url), 'utf8');
