...
const source = readFileSync(
  fileURLToPath(new URL('./PubgSelectLaunchOptions.vue', import.meta.url)),
  'utf8',
);
const pageSource = readFileSync(
  fileURLToPath(new URL('../../../pages/game/PubgPage.vue', import.meta.url)),
  'utf8',
);
const accountSource = readFileSync(
  fileURLToPath(new URL('../SteamUser.vue', import.meta.url)),
  'utf8',
);
