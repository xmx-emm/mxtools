...
const quickPreset = readSource('./preset/ApexQuickPresetDialog.vue');
const gameSettings = readSource('./settings/ApexGameSettings.vue');
const globalCss = readSource('../../../assets/styles/global.css');
