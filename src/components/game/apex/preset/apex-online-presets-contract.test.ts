...
const dialog = readFileSync(new URL('./ApexOnlinePresetsDialog.vue', import.meta.url), 'utf8');
const apexPage = readFileSync(
  new URL('../../../../pages/game/ApexPage.vue', import.meta.url),
  'utf8',
);
const registry = readFileSync(
  new URL('../../../../icons/mdi-icons.ts', import.meta.url),
  'utf8',
);
