...
const settingsSource = readSource('./ApexGameSettings.vue');
const tipSource = readSource('./ApexGameSettingTip.vue');
const laserInputSource = readSource('./ApexLaserSightColorInput.vue');
const settingDataSource = readSource('../../../../data/apex_game_settings.ts');
const laserBackground = readFileSync(fileURLToPath(new URL(
  '../../../../assets/images/apex/laser_sight_preview.jpg',
  import.meta.url,
)));
