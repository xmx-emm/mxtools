...
/** Values owned and regenerated by Apex must not be transferred in snapshots. */
export const APEX_GAME_MANAGED_VIDEO_CONFIG_KEYS = new Set([
...
export function omitApexGameManagedVideoConfig(
  ...
  return Object.fromEntries(
    Object.entries(value).filter(([key]) => !APEX_GAME_MANAGED_VIDEO_CONFIG_KEYS.has(key)),
  );
}
