...
const launchSource = readFileSync(
  fileURLToPath(new URL('../../../../../src/components/game/apex/launch/ApexFilter.vue', import.meta.url)),
  'utf8',
);
const videoSource = readFileSync(
  fileURLToPath(new URL('../../../../../src/components/game/apex/video_config/ApexVideoConfigFilter.vue', import.meta.url)),
  'utf8',
);
