...
const previewSources = [
  readSource('../../../../../src/components/game/apex/launch/tips/ApexReticleColorTip.vue'),
  readSource('../../../../../src/components/game/apex/video_config/tips/ApexVideoMapDetailLevelTip.vue'),
];
