...
describe('Apex runtime binding labels', () => {
  ...
  it('covers observed marking, observer, and keyboard alias commands', () => {
    expect(apexBindingCommandLabels).toMatchObject({
      '+weaponcycle': 'cycleWeapon',
      'ping_specific_type ATTACK': 'pingAttack',
      'ping_specific_type DEFENDING': 'pingDefending',
      in_spec_altitude_lock: 'spectateAltitudeLock',
